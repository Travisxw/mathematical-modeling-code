...
contourf(Nlg,Nlt,sst(:,:,20));shading interp;
% hold on;plot(long,lat);plot(long+360,lat);hold off
colorbar
title('1855年8月SST二维等高线图')

figure
pcolor(Nlg,Nlt,sst(:,:,20));shading interp;
