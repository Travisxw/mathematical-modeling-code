...
hiddennum=5;
outputnum=1;
%更改Count改变对应纬度，1为低纬度，2为中纬度，三为高纬度
Count=3;

%训练数据和预测数据
input_train=input(1:39,4*(Count-1)+1:4*Count)';
input_test=input(40:41,4*(Count-1)+1:4*Count)';
input_test2=input(42:61,4*(Count-1)+1:4*Count)';
output_train=output(1:39,Count)';
output_test=output(40:41,Count)';
% output_test2=output(41:61,Count:4*Count)';
% input_train=input(1:1900,:)';
% input_test=input(1900:2000,:)';
% output_train=output(1:1900)';
% output_test=output(1900:2000)';
